...
public class VAlumnoModifica extends javax.swing.JFrame {
    ...
    public static VAlumnoModifica getInstancia(Alumno alumno){
    ...
    private void jButtonGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGrabarActionPerformed
        ...
        else
        {
            try
            {
                Controlador.getInstance().modificaAlumno(jTextFieldLegajo.getText().toString(), jTextFieldApellido.getText().toString(),
                                           jTextFieldNombre.getText().toString(), jTextFieldCalle.getText().toString(),
                                           Integer.parseInt(jTextFieldNumero.getText()), jTextFieldTelefono.getText().toString(),
