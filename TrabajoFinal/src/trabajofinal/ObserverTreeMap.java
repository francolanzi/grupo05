...
public class ObserverTreeMap<T extends Entidad> implements Observer
{
     ...
     * @throws EntidadInvalidaException El elemento ya se encuentra en la coleccion
     */
     ...
     * @throws IdInvalidoException No hay un elemento con ese id en la coleccion
     */
     ...
     * @throws IdInvalidoException El elemento no esta en la coleccion
     */
