...
public class AddCompetenciaTest
{
    ...
    public void setUp()
    {
        ...
        try
        {
            profesor.addCompetencia(asignatura2);
        }
    ...
    public void testValoresCorrectos()
    {
        try
        {
            ...
            assertTrue("El profesor deberia ser competente", profesor.isCompetente("ASI0001"));
        }
    ...
    public void testIdProfesorNull()
    {
        try
        {
            Controlador.getInstance().addCompetencia(null, "ASI0001");
    ...
    public void testIdProfesorVacio()
    {
        try
        {
            Controlador.getInstance().addCompetencia("", "ASI0001");
            fail("Debio lanzarse IdInvalidoException");
        }
        catch (IdInvalidoException e){}
        catch (EntidadInvalidaException e)
    ...
    public void testIdProfesorInexistente()
    {
        try
        {
            Controlador.getInstance().addCompetencia("PRO2222", "ASI0001");
            fail("Debio lanzarse IdInvalidoException");
        }
        catch (IdInvalidoException e){}
        catch (EntidadInvalidaException e)
    ...
    public void testIdAsignaturaNull()
    {
        try
        {
            Controlador.getInstance().addCompetencia("PRO0001", null);
            fail("Debio lanzarse IdInvalidoException");
        }
        catch (IdInvalidoException e){}
        catch (EntidadInvalidaException e)
    ...
    public void testIdAsignaturaVacio()
    {
        try
        {
            Controlador.getInstance().addCompetencia("PRO0001", "");
            fail("Debio lanzarse IdInvalidoException");
        }
        catch (IdInvalidoException e){}
        catch (EntidadInvalidaException e)
    ...
    public void testIdAsignaturaInexistente()
    {
        try
        {
            Controlador.getInstance().addCompetencia("PRO0001", "ASI2222");
            fail("Debio lanzarse IdInvalidoException");
        }
        catch (IdInvalidoException e){}
        catch (EntidadInvalidaException e)
    ...
    public void testCompentenciaYaAgregada()
    {
        try
        {
            Controlador.getInstance().addCompetencia("PRO0001", "ASI0002");
