...
public class Controlador extends Observable
{
     ...
     * @throws model.IdInvalidoException No existe una asignatura con la identificacion
     ...
     * @throws model.IdInvalidoException No existe un alumno con ese legajo
     */
     ...
     * @throws model.IdInvalidoException No existe un profesor con ese legajo
     */
     ...
     * @throws model.IdInvalidoException No existe una asignatura con esa identificacion
     */
     ...
     * @throws model.IdInvalidoException No existe una cursada con esa identificacion
     */
     ...
     * @throws model.PeriodoInvalidoException El periodo no cumple con la mascara CC-AAAA
     * @throws model.HoraInvalidaException La hora no existe o no cumple con la mascara 99:99
     * @throws model.HorarioNoViableException Algun profesor o alumno de la cursada no puede cursar en el nuevo horario
     */
     ...
     * @throws model.IdInvalidoException No existe una asignatura con alguna de las identificaciones
     * @throws model.EntidadInvalidaException La asignatura ya posee la correlativa
     */
     ...
     * @throws model.HorarioNoViableException El alumno no puede cursar en ese horario
     */
     ...
     * @throws model.HorarioNoViableException El profesor no puede dar clases en ese horario
     */
